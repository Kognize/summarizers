...
# This class is a workaround until this feature is added to LangChain.
# PR waiting approval: https://github.com/langchain-ai/langchain/pull/16807
...
class ConfigurableSemanticChunker(BaseDocumentTransformer):
